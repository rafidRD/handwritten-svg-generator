!(function (e) {
    function t(t) {
        for (var n, i, a = t[0], l = t[1], f = t[2], c = 0, s = []; c < a.length; c++) (i = a[c]), Object.prototype.hasOwnProperty.call(o, i) && o[i] && s.push(o[i][0]), (o[i] = 0);
    ...
    (i.m = e),
        ...
        (i.p = "./");
    var a = (this["webpackJsonptext-animation"] = this["webpackJsonptext-animation"] || []),
        l = a.push.bind(a);
    (a.push = t), (a = a.slice());
